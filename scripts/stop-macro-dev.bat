@echo off
REM ============================================
REM personal-web - Macro App Development Stop
REM Stop macro (8094) + Macro App (3001)
REM ============================================
...
echo.
echo ========================================
echo   Stopping Macro Dev Environment
echo ========================================
echo.

echo [1/2] Stopping services by port with process tree...

REM Check and stop port 8094 (macro)
...
REM Check and stop port 3001 (Macro App)
