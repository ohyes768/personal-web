...
const DOUYIN_SERVICE_URL = process.env.DOUYIN_SERVICE_URL !== undefined && process.env.DOUYIN_SERVICE_URL !== null ? process.env.DOUYIN_SERVICE_URL : 'http://localhost:8093'
